 ...
 * @property {Boolean} [skipDynamicMixing=false] don't call __objexOnMixing
 */
 ...
 *      ```
 */
Objex.create = function() {
    var Super = this,
        Inheritor = arguments[0],
 ...
 */
Objex.mixin = function() {
    var Base = this,
        mixin = arguments[0],
        extendStaticProps = true,
        mixinArgs,
        mixinArgsOffset = 1,
        skipDynamicMixing = false;
    ...
    // mixin static fields
    if (extendStaticProps) {
        skipDynamicMixing = Boolean(extendStaticProps.skipDynamicMixing);
        extendStaticProperties(extendStaticProps, Base, mixin);
    }

    // dynamic mixing
    if ( ! skipDynamicMixing && typeof mixin.__objexOnMixing === 'function') {
